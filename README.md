...
# or
node src/server.js
Sequelize will automatically create all tables using sequelize.sync().
Notes
...
Այստեղ կարող եք տեղադրել ER դիագրամի նկարը:
...
# կամ
node src/server.js
Sequelize-ը ավտոմատ կստեղծի բոլոր աղյուսակները։
Լրացուցիչ Նշումներ
